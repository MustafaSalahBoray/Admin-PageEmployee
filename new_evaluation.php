		...
		<div class="card-body" style="width:1400px;margin:auto; margin-right: 50px;">
			<form  method="POST">
				...
				<div class="row">
					<div class="col-md-6 border-right">
							...
							<label for="" class="control-label">Manager</label>';
                                    ...
                                    $show->execute();
                                     foreach ($show as $key ) {
			                                 $manager_id=$key['manger_id'];
                                   echo '<input type="text" class="form-control" name="Manager_Name" value="'.$key['First_Name'].$key['Last_Name'].'"';
				...
				if (isset($_POST['submit'])) {
				    ...
				    $INSERT->bindparam("Name",$_POST['Manager_Name']);
				    ...
				    $INSERT->bindparam("manger_id",$manager_id);
				   if ( $INSERT->execute()) {
