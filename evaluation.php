			...
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td><b><?php echo $key['Evalouter']?></b></td>
						<td><b>
						...
						<td class="text-center">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item view_evaluation" href="http://localhost/Admin%20PageEmployee/view_evaluation.php?view=<?php echo $key['id']?>" data-id="">View</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="http://localhost/Admin%20PageEmployee/edit_evaluation.php?edit=<?php echo $key['id']?>">Edit</a>
								<div class="dropdown-divider"></div>
  	...
  	$Delete->bindparam("id",$_POST['remove']);
  	 if ($Delete->execute()) {
				   	echo "<script>alert('Done remove')</script>";
				   	   	echo "<script>window.open('http://localhost/Admin%20PageEmployee/index.php?page=evaluation','_self')</script>";
				   }
				   else{
				   	 echo "Erorr";
				   }
