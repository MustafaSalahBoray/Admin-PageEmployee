...
<div class="col-lg-12">
	<div class="card card-outline card-primary ">
		<div class="card-body " style="width:80%;margin: auto; margin-right:50px">
...
<?php
			if (isset($_POST['submit'])) {
				...
				$INSERT=$db->prepare("UPDATE  admn_task SET  Manager_Name=:Manager_Name,Subject=:Subject,comment=:comment	,Stuts=:Stuts,Stuts=:Stuts,Endd=:Endd WHERE id=:id");
