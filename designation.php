		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
                      ...
                      $x=1;
                          require 'DB.php';
                          $SELECT_DEPARTMENT=$db->prepare("SELECT * FROM degisnation");
					...
					<tr>
						...
						<td><p><?php echo $key['Degisnation'];?></p></td>
						<td><p><?php echo $key['Discription'];?></p></td>
						<td class="text-center">
							<div class="btn-group">
								<a href="http://localhost/Admin%20PageEmployee/Edit_degisnation.php?edit=<?php echo $key['id'];?>" data-id='' class="btn btn-primary btn-flat manage_department">
...
<?php 
  if (isset($_POST['remove'])) {
  	$Delete=$db->prepare("DELETE FROM degisnation WHERE id=:id");
